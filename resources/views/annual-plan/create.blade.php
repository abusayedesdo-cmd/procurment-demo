...
@section('title', 'Create Annual Plan')

@section('content')
    <div id="errorBox" class="error-box" style="display:none;"></div>

    <p><a href="{{ route('annual-plans.index') }}">&larr; Back to Plans</a></p>
    ...
    <p class="muted" id="createPlanReadOnlyNote" style="display:none;">Annual Plans are created by the Accountant. Contact your Admin if you need one created.</p>
@endsection
