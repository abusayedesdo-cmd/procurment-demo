...
@section('title', 'ESDO Procurement — User Management')
...
<div class="shell">
    <div class="page-head">
        ...
        <div style="display:flex; gap:.6rem;">
            <a href="{{ route('admin.database.index') }}?table=projects" class="btn outline">Manage Projects</a>
...
<script>
    ...
    window.ADMIN_PROJECTS = @json($projects);
</script>
