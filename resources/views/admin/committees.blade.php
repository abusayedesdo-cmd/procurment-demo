...
@section('title', 'ESDO Procurement — Committee Management')
...
<div class="shell">
    <div class="page-head">
        ...
        <div style="display:flex; gap:.6rem;">
            <a href="{{ route('admin.projects.index') }}" class="btn outline">Projects</a>
...
<script src="{{ asset('js/admin-committees.js') }}"></script>
@endsection