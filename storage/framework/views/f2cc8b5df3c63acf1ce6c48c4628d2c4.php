    ...
    <div class="app-shell">
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="nav-links">
                ...
                ?>
                <div class="nav-group <?php if(in_array($currentPrStatus, $prQuickStatuses)): ?> open <?php endif; ?>" id="prQuickLinksGroup">
                    <!-- <button type="button" class="nav-group-toggle" onclick="toggleNavGroup('prQuickLinksGroup')">
                        <span>PR Status</span>
                        <span class="caret">&#9656;</span>
                    </button> -->
                   
                        <a href="<?php echo e(route('purchase-requisitions.index')); ?>?status=draft">Draft PR</a>
                        <a href="<?php echo e(route('purchase-requisitions.index')); ?>?status=reviewed,checked">Pending Review / Check</a>
                       
                </div>
                <?php if(in_array(auth()->user()->roleName(), \App\Models\User::PR_CREATOR_ROLES)): ?>
                    <a href="<?php echo e(route('purchase-requisitions.create')); ?>"> Create New PR</a>
                <?php endif; ?>
                ...
                <?php if(in_array(auth()->user()->roleName(), [\App\Models\User::PROCUREMENT_OFFICER, \App\Models\User::ADMIN])): ?>
                    ...
                    ?>
                    <div class="nav-group <?php if($currentStepSlug): ?> open <?php endif; ?>" id="processStepsGroup">
                        <button type="button" class="nav-group-toggle" onclick="toggleNavGroup('processStepsGroup')">
                            <span>Process Steps</span>
                            <span class="caret">&#9656;</span>
                        </button>
                        <div class="nav-group-items">
                            <?php $__currentLoopData = \App\Http\Controllers\ProcessStepPageController::STEPS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slug => $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route('process-steps.show', $slug)); ?>"> <?php echo e($s['subject']); ?></a>
