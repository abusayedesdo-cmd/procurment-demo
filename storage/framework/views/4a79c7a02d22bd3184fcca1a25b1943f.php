...
<?php $__env->startSection('title', 'ESDO Procurement — Project Management'); ?>
...
<div class="shell">
    <div class="page-head">
        ...
        <div style="display:flex; gap:.6rem;">
            <a href="<?php echo e(route('admin.users.index')); ?>" class="btn outline">User Management</a>
...
<div class="modal-backdrop" id="teamModalBackdrop">
    <div class="modal">
        ...
        <div class="modal-actions">
            <a href="<?php echo e(route('admin.committees.index')); ?>" class="btn outline sm" target="_blank" rel="noopener">Manage Sub-Committee Members →</a>
...
<script src="<?php echo e(asset('js/admin-projects.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\New Poject\Project_procrument\resources\views/admin/projects.blade.php ENDPATH**/ ?>