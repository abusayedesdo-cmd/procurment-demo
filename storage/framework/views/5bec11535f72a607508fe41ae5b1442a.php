...
<div style="display:flex;justify-content:space-between;align-items:flex-start;gap:16px;flex-wrap:wrap">
  ...
  <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-outline" style="padding:6px 14px;font-size:12.5px;white-space:nowrap">← Back to Dashboard</a>
</div>
...
<?php else: ?>
  <div id="committeeWorkGrid" style="display:grid;grid-template-columns:repeat(auto-fill,minmax(320px,1fr));gap:14px;margin-top:14px">
    <?php $__currentLoopData = $transfers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      ...
      ?>
      <div class="card card-pad" data-search="<?php echo e($searchHaystack); ?>" style="display:flex;flex-direction:column;gap:10px">
