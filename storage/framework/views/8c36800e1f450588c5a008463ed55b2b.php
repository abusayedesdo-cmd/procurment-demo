...
<body>
    <div class="box">
        ...
        <p>RFQ #<?php echo e($rfq->rfq_number); ?> (<?php echo e($rfq->subject); ?>)-এর জন্য আপনার quotation সফলভাবে জমা হয়েছে। ধন্যবাদ।</p>
        <p>প্রয়োজনে ESDO প্রকিউরমেন্ট টিম আপনার সাথে যোগাযোগ করবে।</p>
    </div>
</body>
</html><?php /**PATH D:\New Poject\Project_procrument\resources\views/vendor-portal/thank-you.blade.php ENDPATH**/ ?>