<?php $__env->startSection('title', 'ESDO Procurement — Data Manager'); ?>
...
<div class="shell">
    <div class="page-head">
        ...
        <h1>Data Manager</h1>
        <p>Direct create / read / update / delete access to every table in the database. Changes here bypass normal workflow rules — use with care. (The <code>users</code> table has its own screen: <a href="<?php echo e(route('admin.users.index')); ?>">User Management</a>.)</p>
    </div>
...
<script src="<?php echo e(asset('js/admin-database.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\New Poject\Project_procrument\resources\views/admin/database.blade.php ENDPATH**/ ?>